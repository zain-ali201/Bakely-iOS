...
-(void) viewWillAppear:(BOOL)animated3
{
    ...
    [Util setHeaderColorView:self.view];
...
-(void)setPriceinLabels
{
    ...
    {
        self.lblPriceValue.text = [NSString stringWithFormat:@"%@%@", appDelegate.strCurrencyCode, [self stringByFormattingString:[NSNumber numberWithDouble:Price]]];
        self.lblPriceTotal.text = [NSString stringWithFormat:@"%@%@", appDelegate.strCurrencyCode, [self stringByFormattingString:[NSNumber numberWithDouble:Price]]];
        self.lblPriceTotalFinal.text = [NSString stringWithFormat:@"%@%@", appDelegate.strCurrencyCode, [self stringByFormattingString:[NSNumber numberWithDouble:Price]]];
...
//        self.lblPriceTotalFinal.text = [NSString stringWithFormat:@"%@ %@", appDelegate.strCurrencySymbol, [self stringByFormattingString:[NSNumber numberWithDouble:Price]]];
    ...
    {
        self.lblPriceValue.text = [NSString stringWithFormat:@"%@%@", [self stringByFormattingString:[NSNumber numberWithDouble:Price]], appDelegate.strCurrencyCode];
        self.lblPriceTotal.text = [NSString stringWithFormat:@"%@%@", [self stringByFormattingString:[NSNumber numberWithDouble:Price]], appDelegate.strCurrencyCode];
        self.lblPriceTotalFinal.text = [NSString stringWithFormat:@"%@ %@", [self stringByFormattingString:[NSNumber numberWithDouble:Price]], appDelegate.strCurrencyCode];
...
//    [Util setPrimaryColorView:self.vwTotal];
    ...
    if (appDelegate.isRTL)
    {
        ...
        self.btnContinue.frame = CGRectMake(SCREEN_SIZE.width/375, self.btnContinue.frame.origin.y, self.btnContinue.frame.size.width, self.btnContinue.frame.size.height);
        self.lblPriceTotalFinal.frame = CGRectMake(SCREEN_SIZE.width -  self.lblPriceTotalFinal.frame.size.width - 20*SCREEN_SIZE.width/375, self.lblPriceTotalFinal.frame.origin.y, self.lblPriceTotalFinal.frame.size.width, self.lblPriceTotalFinal.frame.size.height);
    }
    else
    {
        ...
        self.btnContinue.frame = CGRectMake((SCREEN_SIZE.width/2) - 67, self.btnContinue.frame.origin.y, self.btnContinue.frame.size.width, self.btnContinue.frame.size.height);
        self.lblPriceTotalFinal.frame = CGRectMake(20*SCREEN_SIZE.width/375, self.lblPriceTotalFinal.frame.origin.y, self.lblPriceTotalFinal.frame.size.width, self.lblPriceTotalFinal.frame.size.height);
    }
    [self.tblItems reloadData];
    [self setTableframe];
...
//        cell.lblRate.attributedText = [Util setPriceForItem:htmlString];
        ...
        cell.lblRate.text = [NSString stringWithFormat:@"%@ %.1f", appDelegate.strCurrencyCode, object.price];
            ...
            dispatch_async(dispatch_get_global_queue( DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^(void){
                ...
                dispatch_async(dispatch_get_main_queue(), ^(void){
                    ...
                    if (appDelegate.isRTL)
                    {
                        ...
                        starRatingView = [Util setStarRating:object.rating frame:CGRectMake(8 + cell.lblRate.frame.size.width + cell.lblRate.frame.origin.x- ((cell.frame.size.width/2.3)/2), cell.lblTitle.frame.origin.y + cell.lblTitle.frame.size.height+8, (cell.frame.size.width/2.3)/2,appDelegate.FontSizeProductName) tag:1000+indexPath.row];
                        [starRatingView setSemanticContentAttribute:UISemanticContentAttributeForceRightToLeft];
                    }
                    else
                    {
                        //nonRTL
                        starRatingView=[Util setStarRating:object.rating frame:CGRectMake(cell.lblRate.frame.origin.x + 8, cell.lblTitle.frame.origin.y + cell.lblTitle.frame.size.height+8, (cell.frame.size.width/2.1)/2,appDelegate.FontSizeProductName) tag:1000+indexPath.row];
