...
//    [self.webDescription loadHTMLString:[self.strDesc stringByReplacingOccurrencesOfString:@"\n" withString:@"<br/>"] baseURL:nil];
...
//    self.lblDescription.frame = CGRectMake(self.lblDescription.frame.origin.x, self.lblDescriptionTitle.frame.origin.y + self.lblDescriptionTitle.frame.size.height + 15, self.lblDescription.frame.size.width, self.lblDescription.frame.size.height);
