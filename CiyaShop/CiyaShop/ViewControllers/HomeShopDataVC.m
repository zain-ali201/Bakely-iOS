...
//        [Util setPrimaryColorButton:cell.btnStore];
        ...
        else
        {
            ...
            {
                [Util setPrimaryColorButtonImageBG:cell.btnStore image:[UIImage imageNamed:@"cart"]];
            }
            else
            {
                [cell.btnStore setImage:[UIImage imageNamed:@"cart"] forState:UIControlStateNormal];
            }
        }
...
//            cell.alpha = 0.4;
    ...
    if (set == YES)
    {
        [cell.btnWishList setImage:[UIImage imageNamed:@"prod-fav"] forState:UIControlStateNormal];
    }
    else
    {
        [cell.btnWishList setImage:[UIImage imageNamed:@"prod-fav-empty"] forState:UIControlStateNormal];
    }
...
//                [cell.btnAddToCart setTitle:[MCLocalization stringForKey:@"Out of Stock"] forState:UIControlStateNormal];
    ...
    cell.imgProduct.layer.cornerRadius = 10;
